...
const CHILD_ENTRY = join(repoRoot, 'src', 'e2e', 'runtime', 'recovery', 'recovery-crash-child.ts');
const DD_CHILD_ENTRY = join(repoRoot, 'src', 'e2e', 'runtime', 'recovery', 'recovery-dd-crash-child.ts');
