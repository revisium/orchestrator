...
test('issueRef: integrate uses issue-bound branch, non-closing commit and title, and empty PR body', async () => {
  const issueRef = {
...
test('issueRef: captureProducedChange uses issue-bound branch and non-closing commit before publication', async () => {
  const issueRef = {
    repo: 'revisium/orchestrator',
    number: 147,
    url: 'https://github.com/revisium/orchestrator/issues/147',
